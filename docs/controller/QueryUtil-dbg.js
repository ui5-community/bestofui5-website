...
sap.ui.define(["sap/ui/model/Filter", "sap/ui/model/FilterOperator"], function (Filter, FilterOperator) {
  class QueryUtil {
    ...
    applySearchFilter() {
      ...
      const listBinding = list.getBinding("items"); // filter by input field on name and description
      ...
      }.bind(this)); // filter types on object
    ...
    setQueryParameters() {
      ...
      let sortOrder = this.view.getModel("settings").getProperty("/sortOrderDecending"); // dont set 'downloads365' in query because it is default value
      ...
      let queryString = "packages?"; // concat query string for hash with loop over dict, the first one without "&"
