      ...
      var oMockServer = new MockServer({
        ...
        requests: [{
          ...
          response: function (xhr) {
            ...
            oMockModel.loadData("/localService/mockData/data.json", {}, false); // oMockModel.attachRequestCompleted(function() {
          ...
          response: function (xhr) {
            // debugger;
            var oMockModel = new JSONModel();
            oMockModel.loadData("/localService/mockData/contributors.json", {}, false); // oMockModel.attachRequestCompleted(function() {
          ...
          response: function (xhr) {
            // debugger;
            var oMockModel = new JSONModel();
            oMockModel.loadData("/localService/mockData/clones.json", {}, false); // oMockModel.attachRequestCompleted(function() {
          ...
          response: function (xhr) {
            // debugger;
            var oMockModel = new JSONModel();
            oMockModel.loadData("/localService/mockData/versions.json", {}, false); // oMockModel.attachRequestCompleted(function() {
